...
const CATEGORIES = ['GOURMET','CASUAL','CAFETERIA','FAST_FOOD','BAR','PIZZERIA','ITALIANA',
  'MEXICANA','ASIATICA','MARISCOS','PARRILLADA','VEGETARIANA','POSTRES','OTRO'];
const PRICE_RANGES = ['$', '$$', '$$$', '$$$$'];
...
const EMPTY_FORM = {
  ...
  phone: "", email: "", category: "", averagePrice: "", priceRange: "$$",
  openingHours: "", closingHours: "",
  features: { hasParking: false, hasWifi: false, hasDelivery: false, hasTakeout: true, acceptsReservations: true },
...
export const RestaurantesPage = () => {
  ...
  const [editForm, setEditForm] = useState({
    name: "", description: "", address: "", phone: "", email: "", averagePrice: ""
  });
  ...
  const handleUpdateRestaurant = async () => {
    try {
      await updateRestaurant(selectedRestaurant._id, editForm);
      setSuccess("Restaurante actualizado correctamente");
      setShowEditModal(false);
    } catch (err) {
      setError(err.response?.data?.error || "Error al actualizar restaurante");
    }
  };
  ...
  const handleDeleteRestaurant = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.error || "Error al eliminar restaurante");
    }
  };
      ...
      {showForm && (
        <div className="bg-white border rounded-xl p-8 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Información básica */}
            <section>
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wide mb-3">Información básica</h3>
            ...
            {/* Contacto */}
            <section>
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wide mb-3">Contacto</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
            ...
            {/* Dirección */}
            <section>
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wide mb-3">Dirección</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
            ...
            {/* Horario */}
            <section>
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wide mb-3">Horario</h3>
            ...
            {/* Features */}
            <section>
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wide mb-3">Características</h3>
            ...
            {/* Métodos de pago */}
            <section>
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wide mb-3">Métodos de pago</h3>
      ...
      {showEditModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-full max-w-lg">
            <h2 className="text-lg font-semibold mb-4">Editar Restaurante</h2>

            <div className="space-y-4">
              {[
                { name: "name",         label: "Nombre del restaurante" },
                { name: "description",  label: "Descripción" },
                { name: "address",      label: "Dirección" },
                { name: "phone",        label: "Teléfono" },
                { name: "email",        label: "Correo electrónico" },
                { name: "averagePrice", label: "Precio promedio" },
              ].map(({ name, label }) => (
                <div key={name}>
